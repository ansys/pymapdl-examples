...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_verif-manual_vm-008-parametric_calculation.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_verif-manual_vm-008-parametric_calculation.py:
...
.. _sphx_glr_download_verif-manual_vm-008-parametric_calculation.py:
